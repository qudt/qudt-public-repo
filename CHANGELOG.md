...
- `quantitykind:CENTER-OF-MASS` (replacement: `quantitykind:CenterOfMass`)
- `quantitykind:CONTRACT-END-ITEM-SPECIFICATION-MASS` (replacement: `quantitykind:ContractEndItemSpecificationMass`)
- `quantitykind:CONTROL-MASS` (replacement: `quantitykind:ControlMass`)
- `quantitykind:DELTA-V` (replacement: `quantitykind:DeltaV`)
- `quantitykind:DRY-MASS` (replacement: `quantitykind:DryMass`)
...
- `quantitykind:FLIGHT-PERFORMANCE-RESERVE-PROPELLANT-MASS` (replacement: `quantitykind:FlightPerformanceReservePropellantMass`)
- `quantitykind:FUEL-BIAS` (replacement: `quantitykind:FuelBias`)
- `quantitykind:GROSS-LIFT-OFF-WEIGHT` (replacement: `quantitykind:GrossLiftOffWeight`)
...
- `quantitykind:INERT-MASS` (replacement: `quantitykind:InertMass`)
...
- `quantitykind:MASS-DELIVERED` (replacement: `quantitykind:DeliveredMass`)
- `quantitykind:MASS-GROWTH-ALLOWANCE` (replacement: `quantitykind:MassGrowthAllowance`)
- `quantitykind:MASS-MARGIN` (replacement: `quantitykind:MassMargin`)
- `quantitykind:MASS-PROPERTY-UNCERTAINTY` (replacement: `quantitykind:MassPropertyUncertainty`)
- `quantitykind:MaximumBeta-ParticleEnergy` (replacement: `quantitykind:MaximumBetaParticleEnergy`)
- `quantitykind:NOMINAL-ASCENT-PROPELLANT-MASS` (replacement: `quantitykind:NominalAscentPropellantMass`)
- `quantitykind:Non-LeakageProbability` (replacement: `quantitykind:NonLeakageProbability`)
- `quantitykind:PREDICTED-MASS` (replacement: `quantitykind:PredictedMass`)
- `quantitykind:PRODUCT-OF-INERTIA` (replacement: `quantitykind:ProductOfInertia`)
- `quantitykind:RESERVE-MASS` (replacement: `quantitykind:ReserveMass`)
...
- `quantitykind:TARGET-BOGIE-MASS` (replacement: `quantitykind:TargetBogieMass`)
