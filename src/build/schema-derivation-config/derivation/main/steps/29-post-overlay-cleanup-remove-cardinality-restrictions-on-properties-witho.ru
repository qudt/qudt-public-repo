# owl-schema-derive step 29
# Message: Post-overlay cleanup: remove cardinality restrictions on properties without owl:ObjectProperty/owl:DatatypeProperty typing
